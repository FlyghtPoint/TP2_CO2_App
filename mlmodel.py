...
consumption_df['TRANSMISSION']=le.fit_transform(consumption_df['TRANSMISSION'])
consumption_df['FUELTYPE']=le.fit_transform(consumption_df['FUELTYPE'])

x = consumption_df[['MODELYEAR', 'ENGINESIZE', 'CYLINDERS', 'FUELCONSUMPTION_COMB']]
y = consumption_df['CO2EMISSIONS']
